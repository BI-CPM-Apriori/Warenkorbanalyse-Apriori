...
################################################################################
## Form generated from reading UI file 'ergebnissframe1zu1.ui'
##
...
class Ui_Form3(object):
    def setupUi(self, Form):
        ...
        sizePolicy3.setHeightForWidth(self.produkt1.sizePolicy().hasHeightForWidth())
        self.produkt1.setSizePolicy(sizePolicy3)
        font = QFont()
        ...
        self.photo2.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
